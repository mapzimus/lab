...
| --- | --- | --- |
| `/{tool-slug}/` (39 tools) | `mapzimus/max` via the public tool shelf | Full tool library mirrored under `vendor/tools/`. Math and leftover classroom tools moved to lehsmath.com and redirect there. |
