...
103 leagues, men's and women's, in 65 countries (4,363 clubs), each at its
...
2,732 clubs — the lower US tiers and most NCAA programmes — have no Wikidata
item. 2,319 clubs sit on their ground; 1,337 are placed on a college campus and
...
3,157 crests are hotlinked from Wikipedia/Commons at runtime and 396 are
committed under `data/crests/`, taken from the leagues' and colleges' own sites;
all remain trademarks of their clubs. 810 clubs have no crest and draw a
